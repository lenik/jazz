...
import net.sf.freejava.err.UnexpectedException;
import net.sf.freejava.util.NaturalComparator;
...
public class Condition {
    ...
    private static NaturalComparator<String> cmp;
    static {
        cmp = NaturalComparator.getInstance();
    }
