...
public abstract class ProjectExecutor
    ...
    public ProjectExecutor(IProject project, IUserDialog userInterface, Logger logger) {
        if (project == null)
    ...
    public ProjectExecutor(ISession session, IUserDialog userInterface, Logger logger) {
        if (session == null)
