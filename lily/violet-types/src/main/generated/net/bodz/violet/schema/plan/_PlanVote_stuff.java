...
@IdType(Long.class)
public abstract class _PlanVote_stuff
        extends VoteRecord {

    private static final long serialVersionUID = 1L;

    public static final String SCHEMA_NAME = "violet";
    public static final String TABLE_NAME = "plan_vote";
    ...
    /**
     *
     * @constraint foreign key (parent) references violet.plan (id)
     */
    ...
    /**
     */
    public void setParent(@NotNull Plan value) {
        this.parent = value;
    }
