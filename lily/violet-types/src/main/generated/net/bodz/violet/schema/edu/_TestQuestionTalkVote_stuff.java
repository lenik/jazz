...
@IdType(Long.class)
public abstract class _TestQuestionTalkVote_stuff
        extends VoteRecord {

    private static final long serialVersionUID = 1L;

    public static final String SCHEMA_NAME = "violet";
    public static final String TABLE_NAME = "testq_msg_vote";
    ...
    /**
     */
    public void setParent(@NotNull TestQuestionTalk value) {
        this.parent = value;
    }
