...
import net.bodz.violet.shop.dao.SalesPhaseMapper;
...
public class SalesOrderSamples
    ...
    public SalesOrder build()
        ...
        a.setBeginTime(new DateTime(Dates.ISO8601Z.parse("2023-12-13T09:23:17.518+0800").getTime()));
        a.setEndTime(new DateTime(Dates.ISO8601Z.parse("2024-01-03T06:46:10.369+0800").getTime()));
