...
public class UserOtherIdSamples
    ...
    public UserOtherId build()
        ...
        a.setUser(user);
        a.setId(954758213);
        a.setBeginTime(new Timestamp(Dates.ISO8601Z.parse("2023-01-23T22:12:05.853+0800").getTime()));
        a.setEndTime(new Timestamp(Dates.ISO8601Z.parse("2022-12-18T17:32:56.454+0800").getTime()));
        a.setYear(52230391);
