--\import lily.account.user
    ...
    comment on column user_run."user" is 'User: The user';
    comment on column user_run.lastlog is 'Login Time: Last time of login';
    comment on column user_run.lastlogip is 'Login IP: The source IP of last login';
