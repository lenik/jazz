...
public class CoNodeChain_htm<T extends CoNode<T, ?>>
        extends AbstractHttpViewBuilder<CoNodeChain<T>> {
    ...
    @Override
    public IHtmlTag buildHtmlView(IHttpViewContext ctx, IHtmlTag out, IUiRef<CoNodeChain<T>> ref, IOptions options)
