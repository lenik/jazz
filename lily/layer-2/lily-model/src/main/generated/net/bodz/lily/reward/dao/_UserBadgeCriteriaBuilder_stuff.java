...
public class _UserBadgeCriteriaBuilder_stuff
    ...
    Integer badgeId;
    IntegerRange badgeIdRange = new IntegerRange();
    ...
    public IntegerRange getBadgeIdRange() {
        return badgeIdRange;
    }

    public void setBadgeIdRange(IntegerRange range) {
        this.badgeIdRange = range;
    }
