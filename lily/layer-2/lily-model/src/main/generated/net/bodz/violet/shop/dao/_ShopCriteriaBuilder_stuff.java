...
public class _ShopCriteriaBuilder_stuff
    ...
    Integer hydm;
    IntegerRange hydmRange = new IntegerRange();
    ...
    public IntegerRange getHydmRange() {
        return hydmRange;
    }

    public void setHydmRange(IntegerRange range) {
        this.hydmRange = range;
    }
