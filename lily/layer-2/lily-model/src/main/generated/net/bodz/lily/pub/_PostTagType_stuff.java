...
public abstract class _PostTagType_stuff
     ...
     *
     * @label parent
     * @constraint foreign key (parent) references lily.posttag (id)
     */
    public PostTagType getParent() {
        return parent;
    }

    /**
     */
    public void setParent(PostTagType value) {
        this.parent = value;
    }
