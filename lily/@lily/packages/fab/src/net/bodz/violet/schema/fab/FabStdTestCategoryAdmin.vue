...
export const title = "Admin view of: Fab std test category";
...
import FabStdTestCategoryEditor from "./FabStdTestCategoryEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = FabStdTestCategory.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        <template #columns>
            ...
            <th data-type="FabStdTestCategory" data-format="label" data-field="parent">Parent</th>
            <th data-type="INT" data-field="depth">Depth</th>
            <th data-type="INT" data-field="refCount">Ref Count</th>
        </template>
        <template #preview>
            <FabStdTestCategoryEditor class="editor" v-model="selection" />
        </template>
