...
export const title = "Choose dialog for: Fab std test category";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="FabStdTestCategory.TYPE" :typeMap="typeMap" :modal="modal">
