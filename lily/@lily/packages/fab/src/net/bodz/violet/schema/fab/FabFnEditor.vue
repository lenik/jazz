...
import { _FabFn_stuff_TYPE } from "./_FabFn_stuff_TypeInfo";

export const title = "Editor view of: Fab fn";
...
const meta = FabFn.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_FabFn_stuff_TYPE">
            ...
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="fabFnChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
    </div>
