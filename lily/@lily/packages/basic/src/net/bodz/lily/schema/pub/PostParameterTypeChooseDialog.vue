...
export const title = "Choose dialog for: Post parameter type";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="PostParameterType.TYPE" :typeMap="typeMap" :modal="modal">
