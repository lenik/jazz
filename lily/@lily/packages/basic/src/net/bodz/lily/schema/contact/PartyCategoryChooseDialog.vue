...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="PartyCategory.TYPE" :typeMap="typeMap" :modal="modal">
        ...
        <th data-type="PartyCategory" data-format="label" data-field="parent">Parent</th>
