...
import { _ArticleCategory_stuff_TYPE } from "./_ArticleCategory_stuff_TypeInfo";

export const title = "Editor view of: Article category";
...
const model = defineModel<ArticleCategory>();
...
const meta = ArticleCategory.TYPE.property;
    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="CoNode_TYPE">
            ...
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="articleCategoryChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup :type="_ArticleCategory_stuff_TYPE">
