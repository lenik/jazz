...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.meta._TagDef_stuff">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.tagGroup" v-model="model.tagGroup">
                <RefEditor :dialog="tagGroupDefChooseDialog" v-model="model.tagGroupId" v-model:id="model.tagGroupId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup decl="net.bodz.lily.schema.meta.TagDef">
        </FieldGroup>
    </div>
