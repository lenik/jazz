...
export class _ArticleCategory_stuff_TypeInfo extends CoEntityTypeInfo {
    ...
    static validators = new _ArticleCategory_stuff_Validators();
    ...
    static declaredProperty: EntityPropertyMap = {
        ...
        parent: property({ type: net.bodz.lily.schema.pub.ArticleCategoryTypeInfo, validator: this.validators.validateParent }),
        parentId: property({ type: "integer", precision: 10 }),
    }

    constructor() {
        super();
        this.declare(_ArticleCategory_stuff_TypeInfo.declaredProperty);
    }
