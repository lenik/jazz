...
const meta = PostParameterType.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.pub._PostParameterType_stuff">
        ...
        <FieldGroup decl="net.bodz.lily.schema.pub.PostParameterType">
        </FieldGroup>
    </div>
