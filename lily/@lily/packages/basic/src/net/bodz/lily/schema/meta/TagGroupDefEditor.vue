...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.meta._TagGroupDef_stuff">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.forTopic" v-model="model.forTopic">
                <input type="checkbox" v-model="model.forTopic" />
            </FieldRow>
            <FieldRow v-bind="fieldRowProps" :property="meta.forReply" v-model="model.forReply">
        ...
        <FieldGroup decl="net.bodz.lily.schema.meta.TagGroupDef">
        </FieldGroup>
    </div>
