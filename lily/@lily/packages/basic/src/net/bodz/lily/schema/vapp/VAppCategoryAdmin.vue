...
export const title = "Admin view of: V app category";
...
import VAppCategoryEditor from "./VAppCategoryEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = VAppCategory.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        <template #columns>
            ...
            <th data-type="VAppCategory" data-format="label" data-field="parent">Parent</th>
            <th data-type="INT" data-field="depth">Depth</th>
            <th data-type="INT" data-field="refCount">Ref Count</th>
        </template>
        <template #preview>
            <VAppCategoryEditor class="editor" v-model="selection" />
        </template>
