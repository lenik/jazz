...
export class _Uom_stuff_TypeInfo extends CoEntityTypeInfo {
    ...
    static validators = new _Uom_stuff_Validators();
    ...
    static declaredProperty: EntityPropertyMap = {
        ...
        std: property({ type: net.bodz.lily.schema.util.UomTypeInfo, validator: this.validators.validateStd }),
        stdId: property({ type: "integer", precision: 10 }),
    }

    constructor() {
        super();
        this.declare(_Uom_stuff_TypeInfo.declaredProperty);
    }
