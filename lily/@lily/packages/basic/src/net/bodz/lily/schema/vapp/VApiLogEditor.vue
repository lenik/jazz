...
import { _VApiLog_stuff_TYPE } from "./_VApiLog_stuff_TypeInfo";

export const title = "Editor view of: V api log";
...
const model = defineModel<VApiLog>();
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_VApiLog_stuff_TYPE">
            <FieldRow :property="meta.message" v-model="model.message">
                <input type="text" v-model="model.message" />
            </FieldRow>
            <FieldRow :property="meta.err" v-model="model.err">
