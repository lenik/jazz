...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.vapp._VApp_stuff">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.secret" v-model="model.secret">
                <input type="text" v-model="model.secret" />
            </FieldRow>
            <FieldRow v-bind="fieldRowProps" :property="meta.req" v-model="model.req">
                <RefEditor :dialog="vAppRequestChooseDialog" v-model="model.reqId" v-model:id="model.reqId" />
            </FieldRow>
            <FieldRow v-bind="fieldRowProps" :property="meta.category" v-model="model.category">
                <RefEditor :dialog="vAppCatChooseDialog" v-model="model.categoryId" v-model:id="model.categoryId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup decl="net.bodz.lily.schema.vapp.VApp">
        </FieldGroup>
    </div>
