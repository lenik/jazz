...
import { _PhaseDef_stuff_TYPE } from "./_PhaseDef_stuff_TypeInfo";

export const title = "Editor view of: Phase def";
...
const model = defineModel<PhaseDef>();
...
const meta = PhaseDef.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_PhaseDef_stuff_TYPE">
