...
export const title = "Choose dialog for: Zone category";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="ZoneCategory.TYPE" :typeMap="typeMap" :modal="modal">
        ...
        <th data-type="ZoneCategory" data-format="label" data-field="parent">Parent</th>
