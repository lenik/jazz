    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.concrete.CoNode">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="partyCategoryChooseDialog" v-model="model.parentId" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup decl="net.bodz.lily.concrete.CoCategory">
        </FieldGroup>
        <FieldGroup decl="net.bodz.lily.schema.contact._PartyCategory_stuff">
        ...
        <FieldGroup decl="net.bodz.lily.schema.contact.PartyCategory">
        </FieldGroup>
    </div>
