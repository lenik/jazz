...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.meta._ParameterValue_stuff">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.parameter" v-model="model.parameter">
                <RefEditor :dialog="parameterDefChooseDialog" v-model="model.parameterId" v-model:id="model.parameterId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup decl="net.bodz.lily.schema.meta.ParameterValue">
        </FieldGroup>
    </div>
