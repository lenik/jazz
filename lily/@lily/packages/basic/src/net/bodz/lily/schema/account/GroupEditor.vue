...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.account._Group_stuff">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.type" v-model="model.type">
                <RefEditor :dialog="groupTypeChooseDialog" v-model="model.typeId" v-model:id="model.typeId" />
            </FieldRow>
            <FieldRow v-bind="fieldRowProps" :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="groupChooseDialog" v-model="model.parentId" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup decl="net.bodz.lily.schema.account.Group">
        </FieldGroup>
    </div>
