...
import type { ArticleTalkVote } from "./ArticleTalkVote";
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.pub._ArticleTalkVote_stuff">
        ...
        <FieldGroup decl="net.bodz.lily.schema.pub.ArticleTalkVote">
        </FieldGroup>
    </div>
