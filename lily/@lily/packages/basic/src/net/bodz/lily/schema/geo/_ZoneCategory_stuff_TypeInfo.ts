...
export class _ZoneCategory_stuff_TypeInfo extends CoEntityTypeInfo {
    ...
    static validators = new _ZoneCategory_stuff_Validators();
    ...
    static declaredProperty: EntityPropertyMap = {
        ...
        parent: property({ type: net.bodz.lily.schema.geo.ZoneCategoryTypeInfo, validator: this.validators.validateParent }),
        parentId: property({ type: "integer", precision: 10 }),
    }

    constructor() {
        super();
        this.declare(_ZoneCategory_stuff_TypeInfo.declaredProperty);
    }
