...
import type { PostBackref } from "./PostBackref";
...
const meta = PostBackref.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.schema.pub._PostBackref_stuff">
        ...
        <FieldGroup decl="net.bodz.lily.schema.pub.PostBackref">
        </FieldGroup>
    </div>
