...
export const title = "Choose dialog for: User type";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="UserType.TYPE" :typeMap="typeMap" :modal="modal">
        <th data-type="INT" data-field="id">Id</th>
        <th data-type="STRING" data-field="name" title="The user type name">Name</th>
