...
export const title = "Editor view of: Api type";
...
const model = defineModel<ApiType>();
...
const meta = ApiType.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_ApiType_stuff.TYPE">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.uom" v-model="model.uom">
                <input type="text" v-model="model.uom" />
            </FieldRow>
        </FieldGroup>
    </div>
</template>
