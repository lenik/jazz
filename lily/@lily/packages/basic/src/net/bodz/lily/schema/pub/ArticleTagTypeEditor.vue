...
const meta = ArticleTagType.TYPE.property;
    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup decl="net.bodz.lily.concrete.CoNode">
            ...
            <FieldRow v-bind="fieldRowProps" :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="articleTagTypeChooseDialog" v-model="model.parentId" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        ...
        <FieldGroup decl="net.bodz.lily.concrete.CoTag">
        </FieldGroup>
        <FieldGroup decl="net.bodz.lily.schema.pub._ArticleTagType_stuff">
        ...
        <FieldGroup decl="net.bodz.lily.schema.pub.ArticleTagType">
        </FieldGroup>
    </div>
