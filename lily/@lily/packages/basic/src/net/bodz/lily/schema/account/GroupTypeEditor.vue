...
import { _GroupType_stuff_TYPE } from "./_GroupType_stuff_TypeInfo";

export const title = "Editor view of: Group type";
...
const model = defineModel<GroupType>();
...
const meta = GroupType.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_GroupType_stuff_TYPE">
