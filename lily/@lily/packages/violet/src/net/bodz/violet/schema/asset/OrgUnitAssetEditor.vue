...
import { _OrgUnitAsset_stuff_TYPE } from "./_OrgUnitAsset_stuff_TypeInfo";

export const title = "Editor view of: Org unit asset";
...
const model = defineModel<OrgUnitAsset>();
...
const meta = OrgUnitAsset.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_OrgUnitAsset_stuff_TYPE">
            ...
            <FieldRow :property="meta.owner" v-model="model.owner">
                <RefEditor :dialog="orgUnitChooseDialog" v-model="model.owner" v-model:id="model.ownerId" />
            </FieldRow>
        </FieldGroup>
    </div>
