...
export const title = "Admin view of: Std parameter";
...
import StdParameterEditor from "./StdParameterEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = StdParameter.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <StdParameterEditor class="editor" v-model="selection" />
        </template>
