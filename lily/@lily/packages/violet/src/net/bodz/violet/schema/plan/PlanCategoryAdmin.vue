...
export const title = "Admin view of: Plan category";
...
import PlanCategoryEditor from "./PlanCategoryEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = PlanCategory.TYPE;
...
const typeMap = {
    ...
    "PlanCategory": PlanCategory_TYPE,
};
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        <template #columns>
            ...
            <th data-type="PlanCategory" data-format="label" data-field="parent">Parent</th>
            <th data-type="INT" data-field="depth">Depth</th>
            <th data-type="INT" data-field="refCount">Ref Count</th>
        </template>
        <template #preview>
            <PlanCategoryEditor class="editor" v-model="selection" />
        </template>
