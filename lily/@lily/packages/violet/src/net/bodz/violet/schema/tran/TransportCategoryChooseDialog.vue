...
export const title = "Choose dialog for: Transport category";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="TransportCategory.TYPE" :typeMap="typeMap" :modal="modal">
