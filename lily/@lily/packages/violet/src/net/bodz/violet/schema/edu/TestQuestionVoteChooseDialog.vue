...
export const title = "Choose dialog for: Test question vote";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="TestQuestionVote.TYPE" :typeMap="typeMap" :modal="modal">
