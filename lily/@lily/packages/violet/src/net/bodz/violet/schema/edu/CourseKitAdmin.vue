...
export const title = "Admin view of: Course kit";
...
import CourseKitEditor from "./CourseKitEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = CourseKit.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <CourseKitEditor class="editor" v-model="selection" />
        </template>
