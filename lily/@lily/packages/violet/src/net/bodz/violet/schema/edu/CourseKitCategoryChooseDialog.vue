...
export const title = "Choose dialog for: Course kit category";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="CourseKitCategory.TYPE" :typeMap="typeMap" :modal="modal">
