...
import { _StoreCategory_stuff_TYPE } from "./_StoreCategory_stuff_TypeInfo";

export const title = "Editor view of: Store category";
...
const model = defineModel<StoreCategory>();
...
const meta = StoreCategory.TYPE.property;
    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="CoNode_TYPE">
            ...
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="storeCategoryChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup :type="_StoreCategory_stuff_TYPE">
