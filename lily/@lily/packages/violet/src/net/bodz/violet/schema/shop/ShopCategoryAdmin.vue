...
import { ShopCategory_TYPE } from "./ShopCategoryTypeInfo";

export const title = "Admin view of: Shop category";
...
import ShopCategoryEditor from "./ShopCategoryEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = ShopCategory.TYPE;
...
const typeMap = {
    ...
    "ShopCategory": ShopCategory_TYPE,
};
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        <template #columns>
            ...
            <th data-type="ShopCategory" data-format="label" data-field="parent">Parent</th>
            <th data-type="INT" data-field="depth">Depth</th>
            <th data-type="INT" data-field="refCount">Ref Count</th>
        </template>
        <template #preview>
            <ShopCategoryEditor class="editor" v-model="selection" />
        </template>
