...
export const title = "Admin view of: Plan parameter type";
...
import PlanParameterTypeEditor from "./PlanParameterTypeEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = PlanParameterType.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <PlanParameterTypeEditor class="editor" v-model="selection" />
        </template>
