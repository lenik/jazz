...
import { _CourseKitCategory_stuff_TYPE } from "./_CourseKitCategory_stuff_TypeInfo";

export const title = "Editor view of: Course kit category";
...
const model = defineModel<CourseKitCategory>();
...
const meta = CourseKitCategory.TYPE.property;
    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="CoNode_TYPE">
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="courseKitCategoryChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup :type="_CourseKitCategory_stuff_TYPE">
