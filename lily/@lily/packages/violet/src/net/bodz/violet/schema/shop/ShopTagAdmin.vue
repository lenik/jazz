...
import { ShopTag_TYPE } from "./ShopTagTypeInfo";

export const title = "Admin view of: Shop tag";
...
import ShopTagEditor from "./ShopTagEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = ShopTag.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        <template #columns>
            ...
            <th data-type="ShopTag" data-format="label" data-field="parent">Parent</th>
            <th data-type="INT" data-field="depth">Depth</th>
            <th data-type="INT" data-field="refCount">Ref Count</th>
        </template>
        <template #preview>
            <ShopTagEditor class="editor" v-model="selection" />
        </template>
