...
import { _PlanCategory_stuff_TYPE } from "./_PlanCategory_stuff_TypeInfo";

export const title = "Editor view of: Plan category";
...
const model = defineModel<PlanCategory>();
...
const meta = PlanCategory.TYPE.property;
    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="CoNode_TYPE">
            ...
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="planCategoryChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup :type="_PlanCategory_stuff_TYPE">
