...
import { _TestQuestionTalkVote_stuff_TYPE } from "./_TestQuestionTalkVote_stuff_TypeInfo";

export const title = "Editor view of: Test question talk vote";
...
const model = defineModel<TestQuestionTalkVote>();
...
const meta = TestQuestionTalkVote.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_TestQuestionTalkVote_stuff_TYPE">
