...
import { _PersonAsset_stuff_TYPE } from "./_PersonAsset_stuff_TypeInfo";

export const title = "Editor view of: Person asset";
...
const model = defineModel<PersonAsset>();
...
const meta = PersonAsset.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_PersonAsset_stuff_TYPE">
            ...
            <FieldRow :property="meta.owner" v-model="model.owner">
                <RefEditor :dialog="personChooseDialog" v-model="model.owner" v-model:id="model.ownerId" />
            </FieldRow>
        </FieldGroup>
    </div>
