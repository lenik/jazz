...
export const title = "Admin view of: Plan do parameter type";
...
import PlanDoParameterTypeEditor from "./PlanDoParameterTypeEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = PlanDoParameterType.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <PlanDoParameterTypeEditor class="editor" v-model="selection" />
        </template>
