...
import { _CourseCategory_stuff_TYPE } from "./_CourseCategory_stuff_TypeInfo";

export const title = "Editor view of: Course category";
...
const model = defineModel<CourseCategory>();
...
const meta = CourseCategory.TYPE.property;
    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="CoNode_TYPE">
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="courseCategoryChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <FieldGroup :type="_CourseCategory_stuff_TYPE">
