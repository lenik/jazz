...
export const title = "Choose dialog for: Plan do parameter type";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="PlanDoParameterType.TYPE" :typeMap="typeMap" :modal="modal">
