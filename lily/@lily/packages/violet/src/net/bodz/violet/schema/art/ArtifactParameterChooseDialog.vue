...
export const title = "Choose dialog for: Artifact parameter";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="ArtifactParameter.TYPE" :typeMap="typeMap" :modal="modal">
