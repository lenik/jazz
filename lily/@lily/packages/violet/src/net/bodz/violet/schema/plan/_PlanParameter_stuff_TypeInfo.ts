...
export class _PlanParameter_stuff_TypeInfo extends CoParameterTypeInfo {
    ...
    readonly validators = new _PlanParameter_stuff_Validators(this);
...
export default _PlanParameter_stuff_TypeInfo;

export const _PlanParameter_stuff_TYPE = _PlanParameter_stuff_TypeInfo.INSTANCE;
