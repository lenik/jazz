...
export const title = "Admin view of: Sales category";
...
import SalesCategoryEditor from "./SalesCategoryEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = SalesCategory.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        <template #columns>
            ...
            <th data-type="SalesCategory" data-format="label" data-field="parent">Parent</th>
            <th data-type="INT" data-field="depth">Depth</th>
            <th data-type="INT" data-field="refCount">Ref Count</th>
        </template>
        <template #preview>
            <SalesCategoryEditor class="editor" v-model="selection" />
        </template>
