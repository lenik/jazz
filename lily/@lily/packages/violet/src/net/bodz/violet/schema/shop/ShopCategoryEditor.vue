...
import ShopCategoryChooseDialog from "./ShopCategoryChooseDialog.vue";

defineOptions({
    inheritAttrs: false
});

const model = defineModel<ShopCategory>();
...
const meta = ShopCategory.TYPE.property;
const fieldRowProps = getDefaultFieldRowProps({ labelWidth: '7rem' });
provide(FIELD_ROW_PROPS, fieldRowProps);

const rootElement = ref<HTMLElement>();
const shopCategoryChooseDialog = ref<InstanceType<typeof ShopCategoryChooseDialog>>();
...
<template>
    ...
    <ShopCategoryChooseDialog ref="shopCategoryChooseDialog" />
</template>
