...
export const title = "Choose dialog for: User asset";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="UserAsset.TYPE" :typeMap="typeMap" :modal="modal">
        ...
        <th data-type="User" data-format="label" data-field="owner">Owner</th>
