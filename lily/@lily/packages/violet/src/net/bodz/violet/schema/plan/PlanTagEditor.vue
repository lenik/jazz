...
export const title = "Editor view of: Plan tag";
...
import PlanTagChooseDialog from "./PlanTagChooseDialog.vue";

defineOptions({
    inheritAttrs: false
});

const model = defineModel<PlanTag>();
...
const meta = PlanTag.TYPE.property;
const fieldRowProps = getDefaultFieldRowProps({ labelWidth: '7rem' });
provide(FIELD_ROW_PROPS, fieldRowProps);

const rootElement = ref<HTMLElement>();
const planTagChooseDialog = ref<InstanceType<typeof PlanTagChooseDialog>>();
...
<template>
    ...
    <PlanTagChooseDialog ref="planTagChooseDialog" />
</template>
