...
export const title = "Admin view of: Store phase";
...
import StorePhaseEditor from "./StorePhaseEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = StorePhase.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <StorePhaseEditor class="editor" v-model="selection" />
        </template>
