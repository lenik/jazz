...
import { _UserAsset_stuff_TYPE } from "./_UserAsset_stuff_TypeInfo";

export const title = "Editor view of: User asset";
...
const model = defineModel<UserAsset>();
...
const meta = UserAsset.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_UserAsset_stuff_TYPE">
            ...
            <FieldRow :property="meta.owner" v-model="model.owner">
                <RefEditor :dialog="userChooseDialog" v-model="model.owner" v-model:id="model.ownerId" />
            </FieldRow>
        </FieldGroup>
    </div>
