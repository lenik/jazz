...
export const title = "Choose dialog for: Shop item category";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="ShopItemCategory.TYPE" :typeMap="typeMap" :modal="modal">
