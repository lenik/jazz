...
export const title = "Choose dialog for: Plan parameter type";
...
<template>
    <EntityChooseDialog ref="entityChooseDialog" :type="PlanParameterType.TYPE" :typeMap="typeMap" :modal="modal">
