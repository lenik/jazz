...
import { _RegionLevel_stuff_TYPE } from "./_RegionLevel_stuff_TypeInfo";

export const title = "Editor view of: Region level";
...
const model = defineModel<RegionLevel>();
...
const meta = RegionLevel.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_RegionLevel_stuff_TYPE">
