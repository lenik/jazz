...
import { _GroupAsset_stuff_TYPE } from "./_GroupAsset_stuff_TypeInfo";

export const title = "Editor view of: Group asset";
...
const model = defineModel<GroupAsset>();
...
const meta = GroupAsset.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_GroupAsset_stuff_TYPE">
            ...
            <FieldRow :property="meta.owner" v-model="model.owner">
                <RefEditor :dialog="groupChooseDialog" v-model="model.owner" v-model:id="model.ownerId" />
            </FieldRow>
        </FieldGroup>
    </div>
