...
import { _PlanDoVote_stuff_TYPE } from "./_PlanDoVote_stuff_TypeInfo";

export const title = "Editor view of: Plan do vote";
...
const model = defineModel<PlanDoVote>();
...
const meta = PlanDoVote.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_PlanDoVote_stuff_TYPE">
