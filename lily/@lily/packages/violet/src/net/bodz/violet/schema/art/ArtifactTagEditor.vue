...
export const title = "Editor view of: Artifact tag";
...
import ArtifactTagChooseDialog from "./ArtifactTagChooseDialog.vue";

defineOptions({
    inheritAttrs: false
});

const model = defineModel<ArtifactTag>();
...
const meta = ArtifactTag.TYPE.property;
const fieldRowProps = getDefaultFieldRowProps({ labelWidth: '7rem' });
provide(FIELD_ROW_PROPS, fieldRowProps);

const rootElement = ref<HTMLElement>();
const artifactTagChooseDialog = ref<InstanceType<typeof ArtifactTagChooseDialog>>();
    ...
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="CoNode_TYPE">
            ...
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="artifactTagChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
        <CoCodeFieldGroup :meta="meta" v-model="model" />
    </div>
    <ArtifactTagChooseDialog ref="artifactTagChooseDialog" />
</template>
