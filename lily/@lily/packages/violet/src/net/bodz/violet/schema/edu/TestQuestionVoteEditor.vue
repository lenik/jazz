...
import { _TestQuestionVote_stuff_TYPE } from "./_TestQuestionVote_stuff_TypeInfo";

export const title = "Editor view of: Test question vote";
...
const model = defineModel<TestQuestionVote>();
...
const meta = TestQuestionVote.TYPE.property;
...
<template>
    <div class="entity-editor person-editor" ref="rootElement" v-if="model != null" v-bind="$attrs">
        ...
        <FieldGroup :type="_TestQuestionVote_stuff_TYPE">
            ...
            <FieldRow :property="meta.parent" v-model="model.parent">
                <RefEditor :dialog="testQuestionChooseDialog" v-model="model.parent" v-model:id="model.parentId" />
            </FieldRow>
        </FieldGroup>
    </div>
