...
export const title = "Admin view of: Diary parameter type";
...
import DiaryParameterTypeEditor from "./DiaryParameterTypeEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = DiaryParameterType.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <DiaryParameterTypeEditor class="editor" v-model="selection" />
        </template>
