...
export const title = "Admin view of: Artifact phase";
...
import ArtifactPhaseEditor from "./ArtifactPhaseEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = ArtifactPhase.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <ArtifactPhaseEditor class="editor" v-model="selection" />
        </template>
