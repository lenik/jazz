...
export class _SalesCategory_stuff_TypeInfo extends CoCategoryTypeInfo {

    static SCHEMA_NAME = "violet";
    static TABLE_NAME = "salecat";

    static readonly FIELD_NAME = "name";

    static readonly N_NAME = 30;

    readonly validators = new _SalesCategory_stuff_Validators(this);
...
export default _SalesCategory_stuff_TypeInfo;

export const _SalesCategory_stuff_TYPE = _SalesCategory_stuff_TypeInfo.INSTANCE;
