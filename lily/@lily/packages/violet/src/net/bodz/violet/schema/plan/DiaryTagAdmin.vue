...
import { DiaryTag_TYPE } from "./DiaryTagTypeInfo";

export const title = "Admin view of: Diary tag";
...
import DiaryTagEditor from "./DiaryTagEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = DiaryTag.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        <template #columns>
            ...
            <th data-type="DiaryTag" data-format="label" data-field="parent">Parent</th>
            <th data-type="INT" data-field="depth">Depth</th>
            <th data-type="INT" data-field="refCount">Ref Count</th>
        </template>
        <template #preview>
            <DiaryTagEditor class="editor" v-model="selection" />
        </template>
