...
export const title = "Admin view of: Test question talk vote";
...
import TestQuestionTalkVoteEditor from "./TestQuestionTalkVoteEditor.vue";

const props = withDefaults(defineProps<Props>(), {
});

const admin = ref<InstanceType<typeof LilyAdmin>>();
const type = TestQuestionTalkVote.TYPE;
...
<template>
    <LilyAdmin ref="admin" :type="type" :typeMap="typeMap" v-model="selection">
        ...
        <template #preview>
            <TestQuestionTalkVoteEditor class="editor" v-model="selection" />
        </template>
