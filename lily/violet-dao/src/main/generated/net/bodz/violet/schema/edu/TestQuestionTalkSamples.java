...
public class TestQuestionTalkSamples
    ...
    public TestQuestionTalk build()
        ...
        a.setBeginTime(ZonedDateTime.parse("2023-12-14T06:33:54.153-05:00[America/Indiana/Petersburg]", DateTimes.ISO_ZONED_DATE_TIME));
        a.setEndTime(ZonedDateTime.parse("2024-01-20T16:56:48.815-07:00[America/Denver]", DateTimes.ISO_ZONED_DATE_TIME));
