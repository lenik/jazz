...
public class UserOtherIdSamples
    ...
    public UserOtherId build()
        ...
        a.setType(type);
        a.setUser(user);
        a.setBeginTime(OffsetDateTime.parse("2024-12-21T00:20:21.787+01:33", DateTimes.ISO_OFFSET_DATE_TIME));
        a.setEndTime(OffsetDateTime.parse("2025-01-21T16:59:12.79-16:12", DateTimes.ISO_OFFSET_DATE_TIME));
        a.setYear(507267842);
