...
import net.bodz.bas.lop.LexAnnotations;
import net.bodz.bas.lop.LexMatchAcceptor;
import net.bodz.bas.lop._LexMatch;
import net.bodz.bas.lop.LexAnnotations.Alignment;
...
public class JFlexFormatter extends LexMatchAcceptor {
    ...
    private BCharOut        header;
    private BCharOut        decl;
    private BCharOut        body;
