...
public class ActivationByTargetString {
    ...
    public ActivationByTargetString(Class<?> clazz, ProtectionModel pm)
    ...
    public String getTargetString() throws ParseException {
        ...
        if (last == -1)
            throw new ParseException(ProtectNLS
                    .getString("ActivationByTargetString.noChecksum")); //$NON-NLS-1$
        ...
        if (!checksum.equalsIgnoreCase(activateCode.substring(last + 1)))
            throw new ParseException(ProtectNLS
                    .getString("ActivationByTargetString.errorChecksum")); //$NON-NLS-1$
    ...
    static String _digest(String s, long mod) {
        ...
        long remain = new BigInteger(v).mod(BigInteger.valueOf(mod))
                .longValue();
    ...
    public String generateFor(String targetString) {
        ...
        System.out.println(ProtectNLS
                .getString("ActivationByTargetString.searchSpace") + count); //$NON-NLS-1$
        System.out
                .printf(
                        ProtectNLS
                                .getString("ActivationByTargetString.triesPerChar_f"), (double) count / chars.length); //$NON-NLS-1$
