...
/**
 * @test {@link WMISystemInfoTest}
 */
public class WMISystemInfo extends VarMap<String, Object> {
     ...
     * @throws IOException
     */
    public void query(String prefix, String... args) throws WMIException {
    ...
    static String wmic(String... args) throws WMIException {
        if (!wmiSupported)
    ...
    public static WMISystemInfo getInstance() throws WMIException {
        if (instance == null) {
