...
public class ActivatePage extends _Page {
    ...
    class RecalcAdapter implements ModifyListener {
    ...
    protected void createContents(final Composite holder) {
        ...
        final GridData gd_pleaseEnterRegistrationLabel = new GridData(SWT.LEFT,
        ...
        final GridData gd_companyLabel = new GridData(SWT.RIGHT, SWT.CENTER,
                false, false);
        companyLabel.setLayoutData(gd_companyLabel);
        companyLabel.setText("Company: "); //$NON-NLS-1$

        companyText = new Text(holder, SWT.BORDER);
        final GridData gd_companyText = new GridData(SWT.FILL, SWT.CENTER,
                true, false);
        ...
        final GridData gd_emailLabel = new GridData(SWT.RIGHT, SWT.CENTER,
                false, false);
        emailLabel.setLayoutData(gd_emailLabel);
        emailLabel.setText("Email: "); //$NON-NLS-1$

        emailText = new Text(holder, SWT.BORDER);
        final GridData gd_emailText = new GridData(SWT.FILL, SWT.CENTER, true,
                false);
        ...
        final GridData gd_hostIdLabel = new GridData(SWT.RIGHT, SWT.CENTER,
                false, false);
        ...
        final GridData gd_codeLabel = new GridData(SWT.RIGHT, SWT.CENTER,
                false, false);
            ...
            public void verifyText(VerifyEvent e) {
                holder.getDisplay().asyncExec(new Runnable() {
                    ...
                    public void run() {
                        ...
                        propertyChangeSupport.firePropertyChange(PROP_METHODS,
                                null, null);
                    }
                });
            }
        ...
        label.setLayoutData(new GridData(SWT.FILL, SWT.BOTTOM, false, true, 2,
                1));
        label.setText("Label"); //$NON-NLS-1$

        final Label label1 = new Label(holder, SWT.WRAP);
        final GridData gd_label1 = new GridData(SWT.RIGHT, SWT.CENTER, false,
                false, 2, 1);
        ...
        final GridData gd_label2 = new GridData(SWT.RIGHT, SWT.CENTER, false,
                false, 2, 1);
    ...
    void updateABTS() {
        ...
        if (website == null)
            website = "";
        link.setText(String.format(ProtectNLS
                .getString("ActivatePage.accessWebsite_s"), website)); //$NON-NLS-1$
