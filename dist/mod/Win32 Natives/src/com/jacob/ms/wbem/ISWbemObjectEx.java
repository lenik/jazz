...
public class ISWbemObjectEx extends Dispatch {
    ...
    public static final String componentName = "WbemScripting.ISWbemObjectEx"; //$NON-NLS-1$
    ...
    public void refresh_(int iFlags, Object objWbemNamedValueSet) {
        Dispatch.call(this, "Refresh_", new Variant(iFlags), objWbemNamedValueSet); //$NON-NLS-1$
    }
    ...
    public void refresh_(int iFlags) {
        Dispatch.call(this, "Refresh_", new Variant(iFlags)); //$NON-NLS-1$
    }
    ...
    public void refresh_() {
        Dispatch.call(this, "Refresh_"); //$NON-NLS-1$
    }
    ...
    public ISWbemPropertySet getSystemProperties_() {
        return new ISWbemPropertySet(Dispatch.get(this, "SystemProperties_").toDispatch()); //$NON-NLS-1$
    }
    ...
    public String getText_(int iObjectTextFormat, int iFlags, Object objWbemNamedValueSet) {
        return Dispatch.call(this, "GetText_", new Variant(iObjectTextFormat), new Variant(iFlags), //$NON-NLS-1$
    ...
    public String getText_(int iObjectTextFormat) {
        return Dispatch.call(this, "GetText_", new Variant(iObjectTextFormat)).toString(); //$NON-NLS-1$
    }
    ...
    public void setFromText_(String bsText, int iObjectTextFormat, int iFlags,
            Object objWbemNamedValueSet) {
        Dispatch.call(this, "SetFromText_", bsText, new Variant(iObjectTextFormat), new Variant( //$NON-NLS-1$
    ...
    public void setFromText_(String bsText, int iObjectTextFormat) {
        Dispatch.call(this, "SetFromText_", bsText, new Variant(iObjectTextFormat)); //$NON-NLS-1$
    }
