...
public class Session
    ...
    public Session(IProject project, IUserDialogs userDialogs, Logger logger) {
        ...
        MavenPomDir installerPomDir = MavenPomDir.fromClass(ProjectInstaller.class);
        ...
        IFile installerResBase = new PojfFile(installerPomDir.getResourceDir(ProjectInstaller.class));
