...
public class NamedFrame {
     ...
     * @see _FrameTemplate
     */
    public static Runnable wrap(Runnable runnable, String className,
        ...
        Class<?> craftClass = frameClassLoader._defineClass(className, bytes,
                0, bytes.length);

        try {
            Constructor<?> craftCtor = craftClass.getConstructor(String.class,
                    Runnable.class);
    ...
    static class Dump implements Opcodes {
        ...
        public static byte[] dump(String className, String methodName,
                String description) {
            ...
            cw.visit(V1_3, ACC_PUBLIC + ACC_SUPER, internalClassName, null,
                    "java/lang/Object",
                    isRunnable ? new String[] { "java/lang/Runnable" } : null);

            fv = cw.visitField(ACC_PRIVATE + ACC_FINAL, "description",
                    "Ljava/lang/String;", null, null);
            fv.visitEnd();

            fv = cw.visitField(ACC_PRIVATE + ACC_FINAL, "target",
                    "Ljava/lang/Runnable;", null, null);
            fv.visitEnd();

            mv = cw.visitMethod(ACC_PUBLIC, "<init>",
                    "(Ljava/lang/String;Ljava/lang/Runnable;)V", null, null);
            mv.visitCode();
            ...
            mv.visitFieldInsn(PUTFIELD, internalClassName, "description",
                    "Ljava/lang/String;");
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 2);
            mv.visitFieldInsn(PUTFIELD, internalClassName, "target",
                    "Ljava/lang/Runnable;");
            mv.visitInsn(RETURN);
            mv.visitMaxs(2, 3);
            mv.visitEnd();
            ...
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, internalClassName, "target",
                    "Ljava/lang/Runnable;");
            ...
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitFieldInsn(GETFIELD, internalClassName, "description",
                    "Ljava/lang/String;");
