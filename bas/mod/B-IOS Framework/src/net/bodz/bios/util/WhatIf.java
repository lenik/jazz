...
public class WhatIf {
    ...
    public static Collection<Object> send(Receiver sendDst, OutPort grabPort,
            boolean isolate, Object in, boolean flush) throws IOException {
    ...
    public static Collection<Object> send(Receiver sendDst, OutPort grabPort,
            Object in, boolean flush) throws IOException {
        return send(sendDst, grabPort, false, in, flush);
    }

    public static Collection<Object> send(Receiver sendDst, OutPort grabPort,
            boolean isolate, Object in) throws IOException {
    ...
    public static Collection<Object> send(SISOUnit unit, boolean isolate,
            Object in, boolean flush) throws IOException {
    ...
    public static Collection<Object> clearSend(SISOUnit unit, boolean isolated,
            Object in, boolean flush) throws IOException {
        unit.reset();
