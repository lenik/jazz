 ...
 *     Function myFunc1 = Function.build(&quot;myFunc1&quot;, &quot;name&quot;, &quot;age&quot;).setBody(
 *             new StringConcat(Function.built().parameter(&quot;name&quot;), Function
 *                     .built().parameter(&quot;age&quot;)));
 *     Function myFunc2 = Function.build(&quot;myFunc2&quot;, 2).setBody(
 *             new StringConcat(Function.built().parameter(0), Function.built()
 *                     .parameter(1)));
 *     Function myFunc3 = new Function(&quot;myFunc3&quot;).setBody(new StringConcat(
 *             paramName, paramAge));
 * }
 * </pre>
 */
