...
import net.bodz.bas.html.dom.tag.gen._MutableTh;

public class MutableTh
        extends _MutableTh<MutableTh> {

    public MutableTh(IHtmlTag parent, String tagName) {
     ...
     * @default false
     */
    public MutableTh dataRadio(Object val) {
        attr("data-radio", val);
        return this;
    }
     ...
     * @default false
     */
    public MutableTh dataCheckbox(Object val) {
     ...
     * &lt;/table&gt;
     */
    public MutableTh dataField(Object val) {
        attr("data-field", val);
        return this;
    }
     ...
     */
    public MutableTh dataTitle(Object val) {
        attr("data-title", val);
        return this;
    }
     ...
     */
    public MutableTh dataClass(Object val) {
        attr("data-class", val);
        return this;
    }
     ...
     */
    public MutableTh dataAlign(Object val) {
        attr("data-align", val);
        return this;
    }
     ...
     */
    public MutableTh dataHalign(Object val) {
     ...
     */
    public MutableTh dataValign(Object val) {
     ...
     */
    public MutableTh dataWidth(Object val) {
        attr("data-width", val);
        return this;
    }
     ...
     * @default false
     */
    public MutableTh dataSortable(boolean val) {
     ...
     * @default asc
     */
    public MutableTh dataOrder(Object val) {
        attr("data-order", val);
        return this;
    }
     ...
     * @default true
     */
    public MutableTh dataVisible(Object val) {
     ...
     * @default true
     */
    public MutableTh dataSwitchable(Object val) {
     ...
     * @default true
     */
    public MutableTh dataClickToStart(Object val) {
     ...
     * </ul>
     */
    public MutableTh dataFormatter(Object val) {
     ...
     * </ul>
     */
    public MutableTh dataEvents(Object val) {
     ...
     * </ul>
     */
    public MutableTh dataSorter(Object val) {
     ...
     * </ul>
     */
    public MutableTh dataCellStyle(Object val) {
        attr("data-cell-style", val);
        return this;
    }

    public MutableTh dataHeight(Object val) {
