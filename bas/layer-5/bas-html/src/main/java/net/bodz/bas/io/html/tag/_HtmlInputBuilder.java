...
class _HtmlInputBuilder<self_t extends IHtmlTagBuilder<?>>
        extends DecoratedHtmlTagBuilder<self_t> {

    public _HtmlInputBuilder(IXmlTagBuilder o) {
        super(o);
    }
    ...
    /**
      ...
      */
    public self_t accept(String val) {
        attr("accept", val);
        return (self_t) this;
    }
    ...
    /**
      ...
      */
    public self_t checked(String val) {
        attr("checked", val);
        return (self_t) this;
    }
    ...
    public self_t formaction(String val) {
        attr("formaction", val);
        return (self_t) this;
    }

    public self_t formenctype(String val) {
        attr("formenctype", val);
        return (self_t) this;
    }

    public self_t formmethod(String val) {
        attr("formmethod", val);
        return (self_t) this;
    }
    ...
    /**
      ...
      */
    public self_t formnovalidate(String val) {
        attr("formnovalidate", val);
        return (self_t) this;
    }

    public self_t formtarget(String val) {
        attr("formtarget", val);
        return (self_t) this;
    }
    ...
    /**
      ...
      */
    public self_t multiple(String val) {
        attr("multiple", val);
        return (self_t) this;
    }
    ...
    /**
      ...
      */
    public self_t pattern(String val) {
        attr("pattern", val);
        return (self_t) this;
    }
