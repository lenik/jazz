...
class _HtmlFormBuilder<self_t extends IHtmlTagBuilder<?>>
        extends DecoratedHtmlTagBuilder<self_t> {

    public _HtmlFormBuilder(IXmlTagBuilder o) {
        super(o);
    }

    public self_t acceptCharset(String val) {
        attr("accept-charset", val);
        return (self_t) this;
    }

    public self_t action(String val) {
        attr("action", val);
        return (self_t) this;
    }
    ...
    public self_t enctype(String val) {
        attr("enctype", val);
        return (self_t) this;
    }

    public self_t method(String val) {
        attr("method", val);
        return (self_t) this;
    }
    ...
    public self_t novalidate(String val) {
        attr("novalidate", val);
        return (self_t) this;
    }
