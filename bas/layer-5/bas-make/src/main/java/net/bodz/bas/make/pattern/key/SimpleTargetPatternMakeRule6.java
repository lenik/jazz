...
public class SimpleTargetPatternMakeRule6<Tp extends ITargetPattern<Param, T, TK, TT>, Param, TK, Us extends IParameterizedKeys<Param, UK>, UK, //
        ...
        extends SimpleKeyPatternLikeMakeRule6<Tp, Param, TK, IParameterizedKeys<?, ?>, Us, UK, Vs, VK, Ws, WK, Xs, XK, Ys, YK, Zs, ZK, T, TT, U, UT, V, VT, W, WT, X, XT, Y, YT, Z, ZT>
