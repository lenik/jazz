...
public class SimpleDataTypedKeyPatternMakeRule3<Tp extends IDataTypedKeyPattern<Param, K, TT>, Param, K, //
    ...
    public SimpleDataTypedKeyPatternMakeRule3(int priority, @NotNull Tp pattern, @NotNull Us input1s, @NotNull Vs input2s, @NotNull Ws input3s, @NotNull CompileFunction3<T, K, TT, U, UK, UT, V, VK, VT, W, WK, WT> fn) {
    ...
    public static class Builder<Tp extends IDataTypedKeyPattern<Param, K, TT>, Param, K, //
            ...
            Vs extends IDataTypedParameterizedKeys<Param, VK, VT>, VK, //
            Ws extends IDataTypedParameterizedKeys<Param, WK, WT>, WK, //
            T extends IKeyData<K, TT>, TT, U extends IKeyData<UK, UT>, UT, V extends IKeyData<VK, VT>, VT, W extends IKeyData<WK, WT>, WT>
        ...
        public SimpleDataTypedKeyPatternMakeRule3<Tp, Param, K, Us, UK, Vs, VK, Ws, WK, T, TT, U, UT, V, VT, W, WT> build() {
            ...
            return new SimpleDataTypedKeyPatternMakeRule3<>(priority, pattern, input1s, input2s, input3s, fn);
        }
