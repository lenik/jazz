...
public class SimpleTargetTypedKeyPatternMakeRule2<Tp extends ITargetTypedKeyPattern<Param, T, TK, TT>, Param, TK, Us extends IParameterizedKey<Param, UK>, //
        ...
        implements ITargetTypedKeyPatternMakeRule2<Tp, Param, TK, Us, Vs, T, TT, U, UK, UT, V, VK, VT> {
    ...
    public static class Builder<S, Tp extends ITargetTypedKeyPattern<Param, T, TK, TT>, Param, TK, //
        ...
        public Builder<S, Tp, Param, TK, Us, Vs, T, TT, U, UK, UT, V, VK, VT> apply(BiConsumer<S, ITargetTypedKeyPatternMakeRule<Tp, Param, TK, T, TT>> apply) {
            this.apply = apply;
            return this;
        }
        ...
        public SimpleTargetTypedKeyPatternMakeRule2<Tp, Param, TK, Us, Vs, T, TT, U, UK, UT, V, VK, VT> build() {
            if (pattern == null)
