...
public class SimpleDataTypedTarget2KeyPatternMakeRule4<Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //
        ...
        implements IDataTypedTarget2KeyPatternMakeRule4<Tp, Param, TK, Us, UK, Vs, VK, Ws, WK, Xs, XK, T, TT, U, UT, V, VT, W, WT, X, XT> {

    public SimpleDataTypedTarget2KeyPatternMakeRule4(int priority, @NotNull Tp pattern, @NotNull CompileFunction4<T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT> fn, @NotNull Us input1s, @NotNull Vs input2s, @NotNull Ws input3s, @NotNull Xs input4s) {
    ...
    public static class Builder<S, Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //
        ...
        public Builder<S, Tp, Param, TK, Us, UK, Vs, VK, Ws, WK, Xs, XK, T, TT, U, UT, V, VT, W, WT, X, XT> apply(BiConsumer<S, IDataTypedTarget2KeyPatternMakeRule<Tp, Param, TK, T, TT>> apply) {
            this.apply = apply;
            return this;
        }
        ...
        public SimpleDataTypedTarget2KeyPatternMakeRule4<Tp, Param, TK, Us, UK, Vs, VK, Ws, WK, Xs, XK, T, TT, U, UT, V, VT, W, WT, X, XT> build() {
            if (pattern == null)
            ...
            return new SimpleDataTypedTarget2KeyPatternMakeRule4<>(priority, pattern, fn, input1s, input2s, input3s, input4s);
        }
