...
public class SimpleMakeRule1<T extends IDataEntry<TK, TT>, TK, TT, U extends IDataEntry<UK, UT>, UK, UT>
    ...
    public static <T extends IDataEntry<TK, TT>, TK, TT, U extends IDataEntry<UK, UT>, UK, UT> //
    Builder<T, TK, TT, U, UK, UT> builder() {
        return new Builder<>();
    }

    public static class Builder<T extends IDataEntry<TK, TT>, TK, TT, U extends IDataEntry<UK, UT>, UK, UT> {
        ...
        public Builder<T, TK, TT, U, UK, UT> input(@NotNull IDataEntry<?, ?>... inputs) {
            input1 = (U) inputs[0];
            return this;
        }
