...
public interface ITargetPatternMakeRule7<Tp extends ITargetPattern<Param, T, TK, TT>, Param, TK, //
        ...
        extends ITargetPatternLikeMakeRule7<Tp, Param, TK, IParameterizedTarget<?, ?, ?, ?>, U1s, U2s, U3s, U4s, U5s, U6s, U7s, T, TT, U1, U1K, U1T, U2, U2K, U2T, U3, U3K, U3T, U4, U4K, U4T, U5, U5K, U5T, U6, U6K, U6T, U7, U7K, U7T>,
