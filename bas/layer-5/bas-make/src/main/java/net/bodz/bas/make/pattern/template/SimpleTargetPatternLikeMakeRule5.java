...
public abstract class SimpleTargetPatternLikeMakeRule5<Tp extends ITargetPatternLike<Param, T, TK, TT>, Param, TK, //
    ...
    int priority;
    Tp pattern;
    CompileFunction5<T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> fn;
    Us input1s;
    Vs input2s;
    Ws input3s;
    Xs input4s;
    ...
    public SimpleTargetPatternLikeMakeRule5(int priority, @NotNull Tp pattern, @NotNull CompileFunction5<T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> fn, @NotNull Us input1s, @NotNull Vs input2s, @NotNull Ws input3s, @NotNull Xs input4s, @NotNull Ys input5s) {
    ...
    public static abstract class Builder<self_t, Tp extends ITargetPatternLike<Param, T, TK, TT>, Param, TK, //
        ...
        protected CompileFunction5<T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> fn;
        ...
        public self_t fn(@NotNull CompileFunction5<T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> fn) {
            this.fn = fn;
            return _this;
        }
