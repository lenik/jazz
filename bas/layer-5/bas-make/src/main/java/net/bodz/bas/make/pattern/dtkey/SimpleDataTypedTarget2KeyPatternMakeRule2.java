...
public class SimpleDataTypedTarget2KeyPatternMakeRule2<Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //
        ...
        implements IDataTypedTarget2KeyPatternMakeRule2<Tp, Param, TK, Us, UK, Vs, VK, T, TT, U, UT, V, VT> {

    public SimpleDataTypedTarget2KeyPatternMakeRule2(int priority, @NotNull Tp pattern, @NotNull CompileFunction2<T, TK, TT, U, UK, UT, V, VK, VT> fn, @NotNull Us input1s, @NotNull Vs input2s) {
    ...
    public static class Builder<S, Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //
        ...
        public Builder<S, Tp, Param, TK, Us, UK, Vs, VK, T, TT, U, UT, V, VT> apply(BiConsumer<S, IDataTypedTarget2KeyPatternMakeRule<Tp, Param, TK, T, TT>> apply) {
            this.apply = apply;
            return this;
        }
        ...
        public SimpleDataTypedTarget2KeyPatternMakeRule2<Tp, Param, TK, Us, UK, Vs, VK, T, TT, U, UT, V, VT> build() {
            if (pattern == null)
            ...
            return new SimpleDataTypedTarget2KeyPatternMakeRule2<>(priority, pattern, fn, input1s, input2s);
        }
