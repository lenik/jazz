...
public class SimpleTarget2KeyPatternMakeRule__java
        extends Class__java {

    @Override
    public QualifiedName getQName() {
        return QualifiedName.parse("net.bodz.bas.make.pattern.key.SimpleTarget2KeyPatternMakeRule" + inputCount);
    }
    ...
    public void build(JavaCodeWriter out)
        ...
        out.println();
        out.printf("public class SimpleTarget2KeyPatternMakeRule%d<Tp extends ITarget2KeyPattern<Param, T, TK, TT>, Param, TK, ", inputCount);
        out.enter();
        {
            out.enter();
            {
            ...
            out.printf("public SimpleTarget2KeyPatternMakeRule%d(int priority, @NotNull Tp pattern", inputCount);
            ...
            out.enter();
            {
                ...
                out.enter();
                {
                    ...
                    out.printf("return new SimpleTarget2KeyPatternMakeRule%d<>(priority, pattern, fn%s);\n", //
                            inputCount, //
                            comma(Naming.inputVars(inputCount, "s")));
                    out.leave();
                }
