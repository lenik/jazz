...
public class SimpleTarget2KeyPatternMakeRule7<Tp extends ITarget2KeyPattern<Param, T, TK, TT>, Param, TK, U1s extends IParameterizedKey<Param, U1K>, U1K, //
        ...
        implements ITarget2KeyPatternMakeRule7<Tp, Param, TK, U1s, U1K, U2s, U2K, U3s, U3K, U4s, U4K, U5s, U5K, U6s, U6K, U7s, U7K, T, TT, U1, U1T, U2, U2T, U3, U3T, U4, U4T, U5, U5T, U6, U6T, U7, U7T> {

    public SimpleTarget2KeyPatternMakeRule7(int priority, @NotNull Tp pattern, @NotNull CompileFunction7<T, TK, TT, U1, U1K, U1T, U2, U2K, U2T, U3, U3K, U3T, U4, U4K, U4T, U5, U5K, U5T, U6, U6K, U6T, U7, U7K, U7T> fn, @NotNull U1s input1s, @NotNull U2s input2s, @NotNull U3s input3s, @NotNull U4s input4s, @NotNull U5s input5s, @NotNull U6s input6s, @NotNull U7s input7s) {
