...
public interface IDataTypedKeyPatternMakeRule7<Tp extends IDataTypedKeyPattern<Param, K, TT>, Param, K, //
        ...
        extends IKeyPatternLikeMakeRule7<Tp, Param, K, IDataTypedParameterizedKey<?, ?, ?>, U1s, U1K, U2s, U2K, U3s, U3K, U4s, U4K, U5s, U5K, U6s, U6K, U7s, U7K, T, TT, U1, U1T, U2, U2T, U3, U3T, U4, U4T, U5, U5T, U6, U6T, U7, U7T>,
