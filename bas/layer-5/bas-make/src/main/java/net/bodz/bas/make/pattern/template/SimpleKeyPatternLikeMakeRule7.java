...
public abstract class SimpleKeyPatternLikeMakeRule7<Tp extends IKeyPatternLike<Param, K>, Param, K, //
        ...
        implements IKeyPatternLikeMakeRule7<Tp, Param, K, Keys, U1s, U2s, U3s, U4s, U5s, U6s, U7s, T, TT, U1, U1K, U1T, U2, U2K, U2T, U3, U3K, U3T, U4, U4K, U4T, U5, U5K, U5T, U6, U6K, U6T, U7, U7K, U7T> {

    int priority;
    Tp pattern;
    CompileFunction7<T, K, TT, U1, U1K, U1T, U2, U2K, U2T, U3, U3K, U3T, U4, U4K, U4T, U5, U5K, U5T, U6, U6K, U6T, U7, U7K, U7T> fn;
    U1s input1s;
    U2s input2s;
    U3s input3s;
    U4s input4s;
    ...
    public static abstract class Builder<self_t, Tp extends IKeyPatternLike<Param, K>, Param, K, //
        ...
        protected CompileFunction7<T, K, TT, U1, U1K, U1T, U2, U2K, U2T, U3, U3K, U3T, U4, U4K, U4T, U5, U5K, U5T, U6, U6K, U6T, U7, U7K, U7T> fn;
        ...
        public self_t fn(@NotNull CompileFunction7<T, K, TT, U1, U1K, U1T, U2, U2K, U2T, U3, U3K, U3T, U4, U4K, U4T, U5, U5K, U5T, U6, U6K, U6T, U7, U7K, U7T> fn) {
            this.fn = fn;
            return _this;
        }
