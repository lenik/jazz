...
public interface IDataExtendsPattern7<Param, T, T1, T2, T3, T4, T5, T6, T7>
        extends IDataExtendsPattern<Param, T>,
                IParameterType<Param> {

    @Override
    default Class<?>[] getInterfaces() {
        return new Class<?>[] { getType1(), getType2(), getType3(), getType4(), getType5(), getType6(), getType7() };
    }
    ...
    default Param match(Object instance) {
        ...
        T7 type7 = (T7) instance;
        return matchTyped(type1, type2, type3, type4, type5, type6, type7);
    }
    ...
    Param matchTyped(T1 type1, T2 type2, T3 type3, T4 type4, T5 type5, T6 type6, T7 type7);
