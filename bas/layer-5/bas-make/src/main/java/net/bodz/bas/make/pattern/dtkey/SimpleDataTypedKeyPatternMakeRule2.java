...
public class SimpleDataTypedKeyPatternMakeRule2<Tp extends IDataTypedKeyPattern<Param, TK, TT>, Param, TK, //
        ...
        extends SimpleKeyPatternLikeMakeRule2<Tp, Param, TK, IDataTypedParameterizedKey<?, ?, ?>, Us, Vs, T, TT, U, UK, UT, V, VK, VT>
        implements IDataTypedKeyPatternMakeRule2<Tp, Param, TK, Us, Vs, T, TT, U, UK, UT, V, VK, VT> {

    public SimpleDataTypedKeyPatternMakeRule2(int priority, @NotNull Tp pattern, @NotNull CompileFunction2<T, TK, TT, U, UK, UT, V, VK, VT> fn, 
            @NotNull Us input1s, 
            @NotNull Vs input2s) {
    ...
    public static class Builder<S, Tp extends IDataTypedKeyPattern<Param, TK, TT>, Param, TK, //
        ...
        public Builder<S, Tp, Param, TK, Us, Vs, T, TT, U, UK, UT, V, VK, VT> apply(BiConsumer<S, IDataTypedKeyPatternMakeRule<Tp, Param, TK, T, TT>> apply) {
            this.apply = apply;
            return this;
        }
        ...
        public SimpleDataTypedKeyPatternMakeRule2<Tp, Param, TK, Us, Vs, T, TT, U, UK, UT, V, VK, VT> build() {
            if (pattern == null)
