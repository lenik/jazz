...
public class SimpleDataTypedKeyPatternMakeRule2<Tp extends IDataTypedKeyPattern<Param, K, TT>, Param, K, //
    ...
    public SimpleDataTypedKeyPatternMakeRule2(int priority, @NotNull Tp pattern, @NotNull Us input1s, @NotNull Vs input2s, @NotNull CompileFunction2<T, K, TT, U, UK, UT, V, VK, VT> fn) {
    ...
    public static class Builder<Tp extends IDataTypedKeyPattern<Param, K, TT>, Param, K, //
            ...
            Vs extends IDataTypedParameterizedKeys<Param, VK, VT>, VK, //
            T extends IKeyData<K, TT>, TT, U extends IKeyData<UK, UT>, UT, V extends IKeyData<VK, VT>, VT>
            extends SimpleKeyPatternLikeMakeRule2.Builder<Builder<Tp, Param, K, Us, UK, Vs, VK, T, TT, U, UT, V, VT>, Tp, Param, K, Us, UK, Vs, VK, T, TT, U, UT, V, VT> {
        ...
        public SimpleDataTypedKeyPatternMakeRule2<Tp, Param, K, Us, UK, Vs, VK, T, TT, U, UT, V, VT> build() {
            ...
            return new SimpleDataTypedKeyPatternMakeRule2<>(priority, pattern, input1s, input2s, fn);
        }
