...
public class SimpleMakeRule5<T extends IKeyData<TK, TT>, TK, TT, //
    ...
    public static <S, T extends IKeyData<TK, TT>, TK, TT, //
            ...
            X extends IKeyData<XK, XT>, XK, XT, //
            Y extends IKeyData<YK, YT>, YK, YT> //
    Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> builder() {
        return new Builder<>();
    }
    ...
    public static class Builder<S, T extends IKeyData<TK, TT>, TK, TT, //
            ...
            X extends IKeyData<XK, XT>, XK, XT, //
            Y extends IKeyData<YK, YT>, YK, YT> //
            extends SimpleMakeRule.AbstractBuilder<Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT>, S, T, TK, TT> { 
        ...
        public Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> fn(@NotNull IMakeable5<TT, UT, VT, WT, XT, YT> fn) {
            this.fn = fn;
            return this;
        }

        public Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> input(@NotNull IDataTypedKey<UK, UT> input1, @NotNull IDataTypedKey<VK, VT> input2, @NotNull IDataTypedKey<WK, WT> input3, @NotNull IDataTypedKey<XK, XT> input4, @NotNull IDataTypedKey<YK, YT> input5) {
            this.input1 = input1;
            this.input2 = input2;
            this.input3 = input3;
            this.input4 = input4;
        ...
        public Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> input1(@NotNull IDataTypedKey<UK, UT> input1) {
            this.input1 = input1;
            return this;
        }

        public Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> input2(@NotNull IDataTypedKey<VK, VT> input2) {
            this.input2 = input2;
            return this;
        }

        public Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> input3(@NotNull IDataTypedKey<WK, WT> input3) {
            this.input3 = input3;
            return this;
        }

        public Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> input4(@NotNull IDataTypedKey<XK, XT> input4) {
            this.input4 = input4;
            return this;
        }

        public Builder<S, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT, Y, YK, YT> input5(@NotNull IDataTypedKey<YK, YT> input5) {
            this.input5 = input5;
            return this;
        }
        ...
        public void make(@NotNull IMakeable5<TT, UT, VT, WT, XT, YT> fn) {
            make(subject, fn);
        }

        public void make(@NotNull S subject, @NotNull IMakeable5<TT, UT, VT, WT, XT, YT> fn) {
            this.fn = fn;
