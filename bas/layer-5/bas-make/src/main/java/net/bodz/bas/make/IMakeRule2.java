...
public interface IMakeRule2<T extends IKeyData<TK, TT>, TK, TT, U extends IKeyData<UK, UT>, UK, UT, V extends IKeyData<VK, VT>, VK, VT>
        extends IMakeRule<T> {

    @NotNull
    @Override
    default IKeyData<?, ?>[] getInputs() {
        return new IKeyData[] { getInput1(), getInput2() };
    }
