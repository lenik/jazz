...
public interface ITargetPatternLikeMakeRule4<Tp extends ITargetPatternLike<Param, T, TK, TT>, Param, TK, //
    ...
    default BoundRule<T, TK, TT> compile(@NotNull T target, @NotNull IDataBinding binding)
        ...
        SimpleMakeRule4<T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT> rule = SimpleMakeRule4.<T, T, TK, TT, U, UK, UT, V, VK, VT, W, WK, WT, X, XK, XT>builder()//
                .priority(this.getPriority())//
                .input(input1, input2, input3, input4)//
                .fn(fn).build();

        BoundRule<T, TK, TT> instance = new BoundRule<>(rule, target, input1, input2, input3, input4);
        return instance;
    }
