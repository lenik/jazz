...
public class SimpleDataTypedTarget2KeyPatternMakeRuleBuilders__java
        extends Class__java {

    @Override
    public QualifiedName getQName() {
        return QualifiedName.parse("net.bodz.bas.make.pattern.dtkey.SimpleDataTypedTarget2KeyPatternMakeRuleBuilders");
    }
    ...
    public void build(JavaCodeWriter out)
        ...
        out.println();
        out.printf("public abstract class SimpleDataTypedTarget2KeyPatternMakeRuleBuilders<S, Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //\n");
        out.enter();
        {
            out.enter();
            {
            ...
            out.printf("public abstract BiConsumer<S, IDataTypedTarget2KeyPatternMakeRule<Tp, Param, TK, T, TT>> getApply();\n");
        ...
        for (int inputCount = 0; inputCount <= maxCount; inputCount++) {
            ...
            out.printf("SimpleDataTypedTarget2KeyPatternMakeRule%d.Builder<%s> input(%s) {\n", //
                    inputCount, //
                    builderTypeVars, //
                    Naming.inputParams(inputCount, "s", "", "s"));
            out.enter();
            {
                out.printf("return SimpleDataTypedTarget2KeyPatternMakeRule%d.<%s>builder()//\n", inputCount, builderTypeVars);
                out.enter();
                {
                    out.enter();
                    {
