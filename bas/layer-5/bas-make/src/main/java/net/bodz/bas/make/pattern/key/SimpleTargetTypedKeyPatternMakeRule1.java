...
public class SimpleTargetTypedKeyPatternMakeRule1<Tp extends ITargetTypedKeyPattern<Param, T, TK, TT>, Param, TK, Us extends IParameterizedKey<Param, UK>, //
        T extends IKeyData<TK, TT>, TT, //
        U extends IKeyData<UK, UT>, UK, UT> //
        extends SimpleKeyPatternLikeMakeRule1<Tp, Param, TK, IParameterizedKey<?, ?>, Us, T, TT, U, UK, UT>
        implements ITargetTypedKeyPatternMakeRule1<Tp, Param, TK, Us, T, TT, U, UK, UT> {
    ...
    public static class Builder<S, Tp extends ITargetTypedKeyPattern<Param, T, TK, TT>, Param, TK, //
        ...
        public Builder<S, Tp, Param, TK, Us, T, TT, U, UK, UT> apply(BiConsumer<S, ITargetTypedKeyPatternMakeRule<Tp, Param, TK, T, TT>> apply) {
            this.apply = apply;
            return this;
        }
        ...
        public SimpleTargetTypedKeyPatternMakeRule1<Tp, Param, TK, Us, T, TT, U, UK, UT> build() {
            if (pattern == null)
