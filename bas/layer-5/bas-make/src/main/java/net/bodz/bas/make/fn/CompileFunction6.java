...
public interface CompileFunction6<T extends IKeyData<TK, TT>, TK, TT, //
    ...
    default MakeFunction<T> compile(@NotNull T target, IKeyData<?, ?>... inputs) {
        return (t, iv) -> {
            ...
            TT tVal = fn.make(input1.getData(), input2.getData(), input3.getData(), input4.getData(), input5.getData(), input6.getData());
