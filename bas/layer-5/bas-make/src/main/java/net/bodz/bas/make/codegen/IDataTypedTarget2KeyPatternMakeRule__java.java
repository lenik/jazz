...
public class IDataTypedTarget2KeyPatternMakeRule__java
        extends Class__java {

    @Override
    public QualifiedName getQName() {
        return QualifiedName.parse("net.bodz.bas.make.pattern.dtkey.IDataTypedTarget2KeyPatternMakeRule" + inputCount);
    }
    ...
    public void build(JavaCodeWriter out)
        ...
        out.println();
        out.printf("public interface IDataTypedTarget2KeyPatternMakeRule%d<Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //\n", inputCount);
        out.enter();
        {
            out.enter();
            {
                ...
                out.printf("extends IKeyPatternLikeMakeRule%d<Tp, Param, TK, IDataTypedParameterizedKey<?, ?, ?>%s, T, TT%s>,\n", //
                        inputCount, //
                ...
                out.enter();
                {
                    out.enter();
                    {
                        out.printf("IDataTypedTarget2KeyPatternMakeRule<Tp, Param, TK, T, TT> {\n");
                        out.println();
                        out.leave();
                    }
                    out.leave();
