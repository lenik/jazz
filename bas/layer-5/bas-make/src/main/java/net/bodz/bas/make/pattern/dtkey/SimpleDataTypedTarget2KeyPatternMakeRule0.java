...
public class SimpleDataTypedTarget2KeyPatternMakeRule0<Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //
        T extends IKeyData<TK, TT>, TT> //
        extends SimpleKeyPatternLikeMakeRule0<Tp, Param, TK, IDataTypedParameterizedKey<?, ?, ?>, T, TT>
        implements IDataTypedTarget2KeyPatternMakeRule0<Tp, Param, TK, T, TT> {

    public SimpleDataTypedTarget2KeyPatternMakeRule0(int priority, @NotNull Tp pattern, @NotNull CompileFunction0<T, TK, TT> fn) {
    ...
    public static class Builder<S, Tp extends IDataTypedTarget2KeyPattern<Param, T, TK, TT>, Param, TK, //
        ...
        public SimpleDataTypedTarget2KeyPatternMakeRule0<Tp, Param, TK, T, TT> build() {
            if (pattern == null)
                throw new NullPointerException("pattern");
            if (fn == null)
                throw new NullPointerException("fn");
            return new SimpleDataTypedTarget2KeyPatternMakeRule0<>(priority, pattern, fn);
        }
