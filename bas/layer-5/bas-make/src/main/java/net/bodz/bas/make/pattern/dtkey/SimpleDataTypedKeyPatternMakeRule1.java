...
public class SimpleDataTypedKeyPatternMakeRule1<Tp extends IDataTypedKeyPattern<Param, TK, TT>, Param, TK, //
        ...
        extends SimpleKeyPatternLikeMakeRule1<Tp, Param, TK, IDataTypedParameterizedKey<?, ?, ?>, Us, T, TT, U, UK, UT>
        implements IDataTypedKeyPatternMakeRule1<Tp, Param, TK, Us, T, TT, U, UK, UT> {

    public SimpleDataTypedKeyPatternMakeRule1(int priority, @NotNull Tp pattern, @NotNull CompileFunction1<T, TK, TT, U, UK, UT> fn, 
            @NotNull Us input1s) {
    ...
    public static class Builder<S, Tp extends IDataTypedKeyPattern<Param, TK, TT>, Param, TK, //
        ...
        public Builder<S, Tp, Param, TK, Us, T, TT, U, UK, UT> apply(BiConsumer<S, IDataTypedKeyPatternMakeRule<Tp, Param, TK, T, TT>> apply) {
            this.apply = apply;
            return this;
        }
        ...
        public SimpleDataTypedKeyPatternMakeRule1<Tp, Param, TK, Us, T, TT, U, UK, UT> build() {
            if (pattern == null)
