...
public abstract class AbstractSelectionRange<self_t>
        implements
            ISelectionRange,
            IPagination,
            IVarMapForm {
    ...
    public AbstractSelectionRange(long offset) {
        this.offset = offset;
        this.limit = UNLIMIT;
    }

    public AbstractSelectionRange(long offset, long limit) {
        this.offset = offset;
        this.limit = limit;
    }
    ...
    public self_t offset(long offset) {
        this.offset = offset;
        return (self_t) this;
    }
    ...
    public self_t limit(long limit) {
        this.limit = limit;
        return (self_t) this;
    }
    ...
    public self_t countLimit(long countLimit) {
        this.countLimit = countLimit;
        return (self_t) this;
    }
    ...
    public self_t pageByIndex(int pageIndex, int pageSize) {
        setPageSize(pageSize);
        setPageIndex(pageIndex);
        return (self_t) this;
    }

    public self_t pageByNumber(int pageIndex, int pageSize) {
        setPageSize(pageSize);
