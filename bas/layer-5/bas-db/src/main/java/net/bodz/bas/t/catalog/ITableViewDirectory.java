...
public interface ITableViewDirectory {
    ...
    default TableViewList findViews(TableId pattern) {
        return findViews(pattern, false);
    }

    TableViewList findViews(TableId pattern, boolean ignoreCase);

    default ITableViewMetadata getView(TableId pattern) {
        return getView(pattern, false);
    }

    default ITableViewMetadata getView(TableId pattern, boolean ignoreCase) {
