...
class _HtmlOlBuilder<self_t extends IHtmlTagBuilder<?>>
        extends DecoratedHtmlTagBuilder<self_t> {

    public _HtmlOlBuilder(IXmlTagBuilder o) {
        super(o);
    }
    ...
    /**
      ...
      */
    public self_t reversed(String val) {
        attr("reversed", val);
        return (self_t) this;
    }
    ...
    /**
      ...
      */
    public self_t start(String val) {
        attr("start", val);
        return (self_t) this;
    }
