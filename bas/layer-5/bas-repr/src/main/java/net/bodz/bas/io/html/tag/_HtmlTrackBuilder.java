...
class _HtmlTrackBuilder<self_t extends IHtmlTagBuilder<?>>
        extends DecoratedHtmlTagBuilder<self_t> {

    public _HtmlTrackBuilder(IXmlTagBuilder o) {
        super(o);
    }
    ...
    /**
      ...
      */
    public self_t srclang(String val) {
        attr("srclang", val);
        return (self_t) this;
    }
    ...
    /**
      ...
      */
    public self_t default_(String val) {
        attr("default", val);
        return (self_t) this;
    }
