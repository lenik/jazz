...
class _HtmlScriptBuilder<self_t extends IHtmlTagBuilder<?>>
        extends DecoratedHtmlTagBuilder<self_t> {

    public _HtmlScriptBuilder(IXmlTagBuilder o) {
        super(o);
    }
    ...
    public self_t async(String val) {
        attr("async", val);
        return (self_t) this;
    }
     ...
     */
    public self_t defer(String val) {
        attr("defer", val);
        return (self_t) this;
    }
