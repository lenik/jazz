...
public abstract class MappedGUIElementStyleDeclaration
        ...
        implements IGUIElementStyleDeclaration, IFontType, IStrokeType, IFillType {

    private static final long serialVersionUID = 1L;

    public MappedGUIElementStyleDeclaration() {
        super();
    }

    public MappedGUIElementStyleDeclaration(Map<String, String> _orig) {
        super(_orig);
    }
    ...
    /** ⇱ Implementation Of {@link IGUIElementStyleDeclaration}. */
    ...
    public void setParent(ICss3StyleDeclaration parent) {
        if (parent != null)
            if (!(parent instanceof IGUIElementStyleDeclaration))
