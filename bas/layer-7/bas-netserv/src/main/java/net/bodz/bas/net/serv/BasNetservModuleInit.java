...
public class BasNetservModuleInit
    ...
    public void setupBuilder(ConfigurationBuilder<? extends Configuration> builder) {
        builder.add(logger(builder, "net.bodz.bas.net", Level.DEBUG, ansiErrorAppender));
//        builder.add(logger(builder, "net.bodz.bas.text.parser", Level.DEBUG, ansiErrorAppender));
    }
