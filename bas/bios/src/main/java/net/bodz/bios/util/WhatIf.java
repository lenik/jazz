...
public class WhatIf {
    ...
    public static Collection<Object> send(Receiver sendDst, OutPort grabPort, boolean isolate,
    ...
    public static Collection<Object> send(Receiver sendDst, OutPort grabPort, Object in,
