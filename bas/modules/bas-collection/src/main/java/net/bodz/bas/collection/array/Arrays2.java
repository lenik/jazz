...
import net.bodz.bas.closures.alt.Pred1;
...
public class Arrays2 {
    ...
    @SuppressWarnings("unchecked")
    public static <A> A _transform(A array, ITransformer<?, ?> _transformer) {
        ITransformer<Object, Object> transformer = (ITransformer<Object, Object>) _transformer;
        Object[] transformed = transform((Object[]) array, transformer);
        return (A) transformed;
    }

    public static <S, T> T[] transform(S[] array, ITransformer<S, T> transformer) {
        if (array == null)
            return null;
