...
public class IntMathTest {
    ...
    static {
        facs = new Number[] { 1, // 0
                ...
                new BigInteger("1405006117752879898543142606244511569936384000000000"), // 42 //$NON-NLS-1$
                new BigInteger("60415263063373835637355132068513997507264512000000000"), // 43 //$NON-NLS-1$
                new BigInteger("2658271574788448768043625811014615890319638528000000000"), // 44 //$NON-NLS-1$
                new BigInteger("119622220865480194561963161495657715064383733760000000000"), // 45 //$NON-NLS-1$
                new BigInteger("5502622159812088949850305428800254892961651752960000000000"), // 46 //$NON-NLS-1$
                new BigInteger("258623241511168180642964355153611979969197632389120000000000"), // 47 //$NON-NLS-1$
                new BigInteger("12413915592536072670862289047373375038521486354677760000000000"), // 48 //$NON-NLS-1$
                new BigInteger("608281864034267560872252163321295376887552831379210240000000000"), // 49 //$NON-NLS-1$
                new BigInteger("30414093201713378043612608166064768844377641568960512000000000000"), // 50 //$NON-NLS-1$
        };
    }
