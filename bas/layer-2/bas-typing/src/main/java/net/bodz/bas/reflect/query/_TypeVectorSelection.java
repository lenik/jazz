...
import net.bodz.bas.reflect.query.predicate.ITypeVectorPredicate;
...
import net.bodz.bas.reflect.query.predicate.TypeVectorAncestorOf;
import net.bodz.bas.reflect.query.predicate.TypeVectorDerivedFrom;
import net.bodz.bas.reflect.query.predicate.TypeVectorEquals;
