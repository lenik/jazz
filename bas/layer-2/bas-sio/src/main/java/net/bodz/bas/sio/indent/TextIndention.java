...
public class TextIndention
    ...
    public void setIndentLevel(int indentLevel) {
        if (indentLevel < 0)
            throw new IllegalArgumentException("indent level is negative: " + indentLevel);
        ...
        case SPACEONLY: // ignore tabSize
            ...
            break;
        case TABONLY: // ignore tabSize and indentSize
    ...
    public int increaseIndentLevel() {
        ...
        case MIXED:
            ...
            if (addTabs == 0)
                linePrefix += repeat(newSpaces - lastSpaces, ' ');
            else
                linePrefix = linePrefix.substring(0, linePrefix.length() - lastSpaces) //
    ...
    public int decreaseIndentLevel() {
        ...
        case MIXED:
            ...
            if (removeTabs == 0)
                linePrefix = linePrefix.substring(0, linePrefix.length() - (lastSpaces - newSpaces));
            else
                linePrefix = linePrefix.substring(0, linePrefix.length() - lastSpaces - removeTabs) //
                        + repeat(newSpaces, ' ');
            break;
        }
        return indentLevel;
