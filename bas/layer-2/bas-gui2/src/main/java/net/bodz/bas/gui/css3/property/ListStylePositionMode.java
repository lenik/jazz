...
public enum ListStylePositionMode {
     ...
     * content. The marker box is fixed with respect to the principal block box's border and does not
     * scroll with the principal block box's content. In CSS 2.1, a UA may hide the marker if the
     * element's 'overflow' is other than 'visible'. (This is expected to change in the future.) The
     * size or contents of the marker box may affect the height of the principal block box and/or the
     * height of its first line box, and in some cases may cause the creation of a new line box.
