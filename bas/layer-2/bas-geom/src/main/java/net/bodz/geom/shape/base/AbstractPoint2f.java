...
public class AbstractPoint2f
        ...
        implements IPointRef2d, Serializable {
    ...
    @Override
    public IShape2f crop(net.bodz.geom.shape.base.IPointRef2d baseHalfPlane, javax.vecmath.Vector2f normal) {
        return null;
    }
    ...
    @Override
    public ILineRef2f lineFromRef(Point2f start) {
        assert start != null;
        return new ILineRef2f.Ref(start, this);
    }

    @Override
    public ILineRef2f lineToRef(Point2f end) {
        assert end != null;
        return new ILineRef2f.Ref(this, end);
    }

    @Override
    public ILineRef2f.Static lineFrom(Point2f start) {
        assert start != null;
        return new ILineRef2f.Static(start.x(), start.y(), x(), y());
    }

    @Override
    public ILineRef2f.Static lineTo(Point2f end) {
        assert end != null;
        return new ILineRef2f.Static(x(), y(), end.x(), end.y());
    }

    @Override
    public ILineRef2f.Static lineTo(Vector2f dv) {
        assert dv != null;
        return new ILineRef2f.Static(x(), y(), x() + dv.x, y() + dv.y);
    }

    @Override
    public ILineRef2f.Static halfPlane(Vector2f normal) {
        assert normal != null;
