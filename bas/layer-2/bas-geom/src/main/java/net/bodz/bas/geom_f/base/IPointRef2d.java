...
public interface IPointRef2d
     ...
     */
    PositiveHalfPlane positiveTo(Point2d end);

    /**
     * @see CurveOrientation#negative
     */
    PositiveHalfPlane negativeTo(Point2d end);
