...
public interface IPolygon2f
    ...
    ILineRef2f edgeRef(int index);

    ILineRef2f edgeRef(int index1, int index2);

    ILineRef2f.Static edge(int index);

    ILineRef2f.Static edge(int index1, int index2);
    ...
    void addCross(ILineRef2f line);

    List<StaticPoint2f> intersectsAt(ILineRef2f line);

    List<Integer> intersectsAtIndex(ILineRef2f line);

    int intersectsCount(ILineRef2f line);
    ...
    public static class Standard
        ...
        public List<IPointRef2d> points;

        public Standard() {
            this.points = new ArrayList<IPointRef2d>();
        }

        public Standard(List<IPointRef2d> points, boolean copy) {
            if (points == null)
                this.points = new ArrayList<IPointRef2d>();
            else if (copy) {
                this.points = new ArrayList<IPointRef2d>();
                for (IPointRef2d pt : points) {
        ...
        public Standard(List<IPointRef2d> points) {
            this(points, false);
        }
    ...
    public static class StaticFixed
        ...
        public StaticFixed(IPointRef2d[] points) {
            assert points != null;
