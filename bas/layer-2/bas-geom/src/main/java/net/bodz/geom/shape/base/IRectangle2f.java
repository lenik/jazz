...
public interface IRectangle2f
    ...
    void p0(IPointRef2d point);

    void p1(IPointRef2d point);

    void p2(IPointRef2d point);

    void p3(IPointRef2d point);
    ...
    public static class StaticLeft
        ...
        public StaticLeft(IPointRef2d p0, IPointRef2d p2) {
        ...
        public StaticLeft(IPointRef2d p0, Vector2f d2) {
    ...
    public static class StaticRight
        ...
        public StaticRight(IPointRef2d p0, IPointRef2d p2) {
            super(p0.x(), p0.y(), p2.x(), p2.y());
        }
        ...
        public StaticRight(IPointRef2d p0, Vector2f d2) {
            this(p0, p0.addCopy(d2));
        }
    ...
    public static class LeftPositive
        ...
        public LeftPositive(IPointRef2d p0, IPointRef2d p2) {
            super(p0, p2);
            positize();
        }

        public LeftPositive(IPointRef2d p0, Vector2f d2) {
            super(p0, d2);
            positize();
        }
    ...
    public static class RightPositive
        ...
        public RightPositive(IPointRef2d p0, IPointRef2d p2) {
            super(p0, p2);
            positize();
        }

        public RightPositive(IPointRef2d p0, Vector2f d2) {
            super(p0, d2);
            positize();
        }
