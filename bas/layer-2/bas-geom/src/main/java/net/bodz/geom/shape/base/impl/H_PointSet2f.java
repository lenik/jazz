...
public class H_PointSet2f {
    ...
    public static final Point2f[] convertToArray(Object data) {
        if (data == null)
            return null;
        if (data instanceof Point2f)
            return new Point2f[] { (Point2f) data, };
        if (data instanceof Point2f[])
            return (Point2f[]) data;
        ...
        Point2f[] pts = new Point2f[list.size()];
        list.toArray(pts);
