...
public abstract class AbstractRectangle2f
    ...
    public void p2(IPointRef2d p2) {
        x2(p2.x());
        y2(p2.y());
    }

    public void p3(IPointRef2d p3) {
        x3(p3.x());
        y3(p3.y());
    }
    ...
    public int outcode(IPointRef2d point) {
        assert point != null;
    ...
    public String toString() {
        return String.format("<Rectangle x0='%f' y0='%f' x2='%f' y2='%f' />", x0(), y0(), x1(), y1());
    }
    ...
    public PickInfo2f pickInfo(float x, float y) {
        ...
        IPointRef2d c = pos.spointRef(SP_CENTER);
        int Hsel = x < c.x() ? 0 : 1;
        int Vsel = y < c.y() ? 0 : 2;
        float dx, dy;
    ...
    public float distance(float x, float y) {
        IPointRef2d c = pointRef(SP_CENTER);
    ...
    public boolean addWithScale(IPointRef2d point) {
        assert point != null;
