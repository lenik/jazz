...
public class MovableByteBufferOutputStream
    ...
    public MovableByteBufferOutputStream(MovableByteBuffer buffer) {
        this(buffer, buffer.size());
    }

    public MovableByteBufferOutputStream(MovableByteBuffer buffer, int position) {
        this.buffer = buffer;
