...
import net.bodz.bas.annotation.util.impl.DiscardableArrayList;
import net.bodz.bas.annotation.util.impl.IDiscardableList;
import net.bodz.bas.annotation.util.impl.UniqueArrayList;

public class TagStyleAnnotationUtil
     ...
     */
    protected static final <A extends Annotation> String[] getTags(Class<A> annotationType, ValueFunction<A> valuef,
     ...
     * @return Empty string array if no author. Or
     */
    protected static final <A extends Annotation> String[] getClassTags(Class<A> annotationType,
            ValueFunction<A> valuef, Class<?> clazz, boolean mergeAllOccurences, boolean reverseOrder,
            final boolean unique) {
        if (clazz == null)
            throw new NullPointerException("clazz");

        if (!mergeAllOccurences && !unique)
            return getTags(annotationType, valuef, clazz);
