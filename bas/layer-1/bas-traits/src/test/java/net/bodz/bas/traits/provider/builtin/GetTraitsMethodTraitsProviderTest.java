...
public class GetTraitsMethodTraitsProviderTest
    ...
    public void testGetTraitsStaticUndefined() {
        InputStream traits = provider.getTraits(StaticFoo.class, InputStream.class);
        assertNull(traits);
    }
    ...
    public void testGetTraitsNonStaticDefined() {
        ...
        IFormatter<NonstaticFoo> formatter1 = provider.getTraits(NonstaticFoo.class, foo1, IFormatter.class);
        IFormatter<NonstaticFoo> formatter2 = provider.getTraits(NonstaticFoo.class, foo2, IFormatter.class);
    ...
    public void testGetTraitsNonStaticUndefined() {
        InputStream traits = provider.getTraits(NonstaticFoo.class, InputStream.class);
        assertNull(traits);
    }
