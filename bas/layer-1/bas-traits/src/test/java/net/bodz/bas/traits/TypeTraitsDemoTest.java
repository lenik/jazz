...
public class TypeTraitsDemoTest
    ...
    static ICommonTraits<? super Address> postAddressType = TypeTraitsResolve.findTraits(Address.class);
    static ICommonTraits<? super Address> nonpostAddressType = new AddressTraits(false);
