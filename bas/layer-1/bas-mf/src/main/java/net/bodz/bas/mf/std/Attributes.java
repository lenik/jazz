...
public class Attributes
    ...
    private Map<String, ICommonMdaFeatures<?>> typeMap;;

    public Attributes() {
        this(null);
    }

    public Attributes(Map<String, ICommonMdaFeatures<?>> typeMap) {
    ...
    public void setAttributeTypeInfo(String name, ICommonMdaFeatures<?> typeInfo) {
        if (name == null)
            throw new NullPointerException("name");
        if (typeInfo == null)
            throw new NullPointerException("typeInfo");
        if (typeMap == null)
            typeMap = new HashMap<String, ICommonMdaFeatures<?>>();
