...
import net.bodz.bas.lang.err.CorruptedStateError;
...
/**
 * @test {@link _ListEditorTest}
 */
public abstract class _ListEditor<T> extends Composite {
    ...
    class ArrangeAdapter extends MouseAdapter implements MouseMoveListener {
    ...
    public _ListEditor(Composite parent, int style) {
        super(parent, style);
