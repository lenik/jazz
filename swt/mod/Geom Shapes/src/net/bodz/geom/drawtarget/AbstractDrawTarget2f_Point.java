...
public abstract class AbstractDrawTarget2f_Point extends AbstractDrawTarget2f {

    @Override
    public abstract void drawPixel(Point2f point) throws DrawException;

    @Override
    public void drawPixel(float x, float y) throws DrawException {
    ...
    @Override
    public void fillRectangle(Rectangle2f rect) throws DrawException {
