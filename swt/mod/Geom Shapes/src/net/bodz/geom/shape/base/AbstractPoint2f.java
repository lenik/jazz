...
public abstract class AbstractPoint2f extends AbstractShape2f implements
    ...
    /*
     * void move(float dx, float dy); void scale(float kx, float ky); void
     * rotate(float angle); void scale(float kx, float ky, float baseX, float
     * baseY); void rotate(float angle, float baseX, float baseY);
     */
