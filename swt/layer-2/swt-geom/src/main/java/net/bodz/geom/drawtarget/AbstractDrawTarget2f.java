...
public abstract class AbstractDrawTarget2f implements DrawTarget2f {
    ...
    public void drawPolygon(Polygon2f polygon) throws DrawException {
        ...
        Point2f pre = polygon.pointRef((n + offset - 1) % n);
        for (int i = offset; i < n; i++) {
            Point2f p = polygon.pointRef(i);
            drawLine(pre, p);
            pre = p;
        }
    }
    ...
    public void fillPolygon(Polygon2f polygon) throws DrawException {
        Triangle2f[] triangles = polygon.toTriangles();
    ...
    public void drawLine(Line2f line) throws DrawException {
    ...
    public void drawRectangle(Rectangle2f rect) throws DrawException {
    ...
    public void drawCircle(Point2f center, float radius) throws DrawException {
    ...
    public void drawPolygon(float[] x, float[] y) throws DrawException {
        assert x != null;
        assert y != null;
    ...
    public void fillCircle(Point2f center, float radius) throws DrawException {
    ...
    public void fillPolygon(float[] x, float[] y) throws DrawException {
        assert x != null;
        assert y != null;
        int size = Math.min(x.length, y.length);
