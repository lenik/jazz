...
public interface Overlay extends Paintable {
    ...
    /**
     * @param bounds
     *            the paint operation must be limited in the region. otherwise,
     *            a upward-invalidation must be invoked.
     * 
    ...
    /**
     * @return undefined if <code>isInvalid(null)</code> returns
     *         <code>false</code>.
     */
    @Const
