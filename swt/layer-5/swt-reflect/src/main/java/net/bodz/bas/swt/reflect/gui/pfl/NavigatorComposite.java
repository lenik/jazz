 ...
 */
public class NavigatorComposite extends Composite implements PageContext {
    ...
    class _PageFlow extends PageFlow {
        ...
        @Override
        protected void showTurn(TreePath prev, TreePath path) throws PageException {
            if (prev != null) {
    ...
    void createContents() {
        ...
        if ((flags & SHOW_BEGIN) != 0) {
            ...
            goBeginButton
                    .setImage(SWTResources.getImageRes("/icons/full/etool16/shift_l_edit.gif")); //$NON-NLS-1$
    ...
    class RefreshAdapter implements PropertyChangeListener {
    ...
    void showPage(final TreePath path) throws PageException {
