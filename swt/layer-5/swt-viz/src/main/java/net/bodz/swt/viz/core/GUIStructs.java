...
import net.bodz.bas.gui.err.GUIAccessException;
...
import net.bodz.swt.viz.core.GUIVars.GUIFieldVar;
import net.bodz.swt.viz.core.GUIVars.GUIPropertyMeta;
import net.bodz.swt.viz.core.GUIVars.GUIPropertyVar;
...
public class GUIStructs {
    ...
    public static class ClassMeta {
        ...
        private List<SwtEntryMetadata> list;
        private Map<String, SwtEntryMetadata> map;
        ...
        protected ClassMeta(ClassMeta prev, Class<?> clazz, int flags)
            ...
            if (nodup)
                map = new HashMap<String, SwtEntryMetadata>();
            else
                list = new ArrayList<SwtEntryMetadata>();
        ...
        void add(String name, SwtEntryMetadata meta) {
            if (map != null) {
        ...
        protected void getContents(List<SwtEntryMetadata> buf) {
            if (map != null)
        ...
        public List<SwtEntryMetadata> getContents() {
            List<SwtEntryMetadata> buf = new ArrayList<SwtEntryMetadata>( //
    ...
    public static class GUIObjectStruct
        ...
        public GUIObjectStruct(Object object) {
            ...
            this.object = object;
            List<SwtEntryMetadata> metas = this.meta.getContents();
            // sort?
            for (SwtEntryMetadata meta : metas) {
                SwtEntry<?> var;
