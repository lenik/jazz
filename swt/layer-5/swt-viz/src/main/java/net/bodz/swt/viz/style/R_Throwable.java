...
import net.bodz.swt.viz.IAction;
import net.bodz.swt.viz.SWTRenderContext;
import net.bodz.swt.viz.SWTRenderer;
import net.bodz.swt.viz.AbstractAction;
...
public class R_Throwable
    ...
    public Control render(final SWTRenderContext rc, final SwtEntry<?> var, final Composite parent, final int style)
        ...
        if (showTools) {
            ...
            IAction copyAction = new AbstractAction(copyImage, GUINLS.getString("R_Throwable.copy"),
            ...
            IAction mailAction = new AbstractAction(mailImage, //
        ...
        if (showDebug) {
            ...
            IAction debugAction = new AbstractAction(debugImage, //
