...
import net.bodz.swt.widgets.RolloverButtonTest;
...
/**
 * @test {@link RolloverButtonTest}
 */
public class RolloverButton extends Label {
    ...
    class MouseAdapter implements MouseListener, MouseTrackListener, MouseMoveListener {
