...
public class IntegerEntryBuilder
        extends AbstractFieldEntryBuilder<String, Text, TextEntry, IntegerEntryBuilder> {

    public IntegerEntryBuilder(FieldEntryForm formBuilder) {
        super(formBuilder);
    }
